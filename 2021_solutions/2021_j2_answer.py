"""
CCC 2021 Junior - Problem J2 - Answer
============================================================

Silent Auction
Given N bids, find the highest bid. If tie, the person who bid first wins.
...
def solve():
    """
    Solution for CCC 2021 Junior Problem J2 - Silent Auction
    Time: O(N), Space: O(1) - track max only
    """
    n = int(input())
