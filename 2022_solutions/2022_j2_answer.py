"""
CCC 2022 Junior - Problem J2 - Answer
============================================================

Fergusonball Ratings
Each player: 5 stars per point, -3 stars per foul
Count players with rating > 40
If all players > 40, append "+"
...
def solve():
    """
    Solution for CCC 2022 Junior Problem J2 - Fergusonball Ratings
    Time: O(N), Space: O(1)
    """
    n = int(input())
