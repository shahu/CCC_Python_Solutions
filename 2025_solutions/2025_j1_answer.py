"""
CCC 2025 Junior - Problem J1 - Answer
============================================================

Roller Coaster Ride
Given position N in line, C cars, P people per car.
Output "yes" if N <= C*P, else "no".
...
def solve():
    """
    Solution for CCC 2025 Junior Problem J1 - Roller Coaster Ride
    Time: O(1), Space: O(1)
    """
