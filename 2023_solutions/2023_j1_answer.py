"""
CCC 2023 Junior - Problem J1 - Answer
============================================================

Deliv-e-droid
P = packages delivered, C = collisions
Score = 50*P - 10*C (+500 bonus if P > C)
...
def solve():
    """
    Solution for CCC 2023 Junior Problem J1 - Deliv-e-droid
    Time: O(1), Space: O(1)
    """
    P = int(input())
    C = int(input())
