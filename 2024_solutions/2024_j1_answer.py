"""
CCC 2024 Junior - Problem J1 - Answer
============================================================

Conveyor Belt Sushi
Red plates = $3, Green plates = $4, Blue plates = $5
...
def solve():
    R = int(input())  # Red plates ($3 each)
    G = int(input())  # Green plates ($4 each)
    B = int(input())  # Blue plates ($5 each)
